        ...
        return $content
            ...
            ->body('Defautl page have not seted ,pleace edit config in `config/admin.php`'
                ...
                'iframe-tabs' => [
                    ...
                    'bind_selecter' => '.box-body table.table tbody td.column-__actions__ .dropdown-menu,.box-body table.table tbody a.grid-row-view,.box-body table.table tbody a.grid-row-edit,.box-header .pull-right .btn-success,.popup',
